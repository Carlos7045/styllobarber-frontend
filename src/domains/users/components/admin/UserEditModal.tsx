...
import { Button, Input, Card, CardContent, CardHeader, CardTitle, Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/shared/components/ui'
import { UserProfile } from '@/domains/auth/hooks/use-auth'
        ...
        <CardContent>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={watch('role')}
                onValueChange={(value) => setValue('role', value as 'admin' | 'barber' | 'client')}
              >
