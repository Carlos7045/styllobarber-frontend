...
import { useAdminServicos, type HistoricoPreco } from '@/hooks/use-admin-servicos'
import { History, DollarSign, User, Calendar, TrendingUp, TrendingDown } from 'lucide-react'
    ...
    >
      <ModalHeader>
        <div className="flex items-center gap-3">
          ...
          <div>
            <ModalTitle>Histórico de Alterações de Preços</ModalTitle>
