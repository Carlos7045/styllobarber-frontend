          ...
          <Card className="border-l-4 border-l-green-500">
            ...
            <CardContent>
              <div className="space-y-2 text-sm">
                <p>• Esta página mostra informações detalhadas sobre o usuário logado</p>
                <p>• Use para debugar problemas de permissões e roles</p>
                <p>• Monitor de performance mostra métricas de cache e queries</p>
                <p>• Acesse via <code className="bg-gray-100 px-1 rounded">/debug</code></p>
