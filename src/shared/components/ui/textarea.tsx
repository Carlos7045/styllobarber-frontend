...
const textareaVariants = cva(
  ...
  'flex min-h-[80px] w-full rounded-lg border px-3 py-2 text-sm transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-gold focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 resize-none',
  {
    variants: {
        ...
        <div className="flex justify-between items-start mt-1">
          ...
          {showCharCount && maxLength && (
            <p className={cn(
              ...
              charCount > maxLength * 0.9 ? 'text-warning' : 'text-gray-600 dark:text-gray-400',
